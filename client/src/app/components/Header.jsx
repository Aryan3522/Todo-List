...
const Header = ({ sideBarOpen }) => {
  ...
  const { dispatch: dailyDispatch, searchQuery, setSearchQuery } = useContext(DailyContext);
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-50 focus:bg-white transition-all w-64"
          />
